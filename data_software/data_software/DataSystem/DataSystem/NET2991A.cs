...
using static DataSystem.Views.Dev2991View;
using DataSystem;
...
namespace DataSystem
{
    ...
    class NET2991A
    {
        ...
        {
            UInt16[] nAIArray = new UInt16[4096];
            UInt32 dwReadChan = 0;
        ...
        public static bool InitDevice(string strIP, string strDevPort, string strLocalPort, MsgUpdateDelegate std)
        {
            Int32 nIndex = 0;
            ...
            // DEVICE_NET_INFO iNFO = new DEVICE_NET_INFO();
            //iNFO.nDeviceIP = (UInt32)(System.Net.IPAddress.NetworkToHostOrder(inet_addr("192.168.1.145")));
            //NET2991A.NET2991_DEV_SetNetInfo(cfgPara.hDevice,ref iNFO);
        ...
        public static bool start()
        {
            ...
            needStop = false;
            Thread tDataRead = new Thread(new ThreadStart(ReadDataFun));
            tDataRead.Start();
            return true;
        }
    }
