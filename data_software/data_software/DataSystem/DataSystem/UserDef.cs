...
namespace DataSystem
{
    class UserDef
    {
        public static volatile bool done = true;
        public static BlockingCollection<List<double>> syncQueDwt = new BlockingCollection<List<double>>(2);
        public static BlockingCollection<FreDataObject> syncQueFre = new BlockingCollection<FreDataObject>(2);
        ...
        public const String PathDir = @"C:\\Users\Administrator\\Desktop\\NET\\NET\\OneDimNetForObject\\data\\数据";
